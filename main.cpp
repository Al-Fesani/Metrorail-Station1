...
if (positionboat < -2.0)
  ...
  /*  ///bus
    ...
    if ( position < 0.56-0.0 && position >0.5-0.2)
        {
            position -= 0.001;
        }
    ...
    if ( busposition < 0.56-0.0 && busposition >0.5-0.2)
        {
            busposition -= 0.001;
        }
...
void ship()
{
   ...
   glVertex2f(-0.954167f,-0.0314815f);
   glVertex2f(-0.885417f,-0.135185f);
   glVertex2f(-0.610417f,-0.135185f);
   glVertex2f(-0.540625f,-0.0314815f);
    glEnd();
...
glBegin(GL_POLYGON); //2nd lower porsion
   ...
   glVertex2f(-0.954167f,-0.0314815f);
   glVertex2f(-0.540625f,-0.0314815f);
   glVertex2f(-0.540625f,-0.0148148f);
   glVertex2f(-0.954167f,-0.0148148f);
    glEnd();

    glBegin(GL_POLYGON); //3rd lower porsion
    glColor3ub(113,113,113);
   glVertex2f(-0.926042f,-0.0148148f);
   glVertex2f(-0.569792f,-0.0148148f);
   glVertex2f(-0.569792f,0.0277778f);
   glVertex2f(-0.926042f,0.0277778f);
    glEnd();


 glBegin(GL_POLYGON); //4th lower porsion
    glColor3ub(194,187,225);
 glVertex2f(-0.907292f,0.0277778f);
 glVertex2f(-0.576042f,0.0277778f);
 glVertex2f(-0.598958f,0.0796296f);
 glVertex2f(-0.907292f,0.0796296f);
    glEnd();

 glBegin(GL_POLYGON); //4th lower porsion
    glColor3ub(184,124,85);
 glVertex2f(-0.904167f,0.0796296f);
 glVertex2f(-0.601042f,0.0796296f);
  glVertex2f(-0.640625f,0.0962963f);
  glVertex2f(-0.867708f,0.0962963f);
    glEnd();

 glBegin(GL_POLYGON); ///1st uper part1
    glColor3ub(0,0,0);
  glVertex2f(-0.836458f,0.0962963f);
  glVertex2f(-0.807292f,0.0962963f);
  glVertex2f(-0.807292f,0.140741f);
  glVertex2f(-0.836458f,0.140741f);
    glEnd();*/
...
///tyre
    ...
    int i;
	GLfloat x=-0.496875f; GLfloat y=-0.557407f; GLfloat radius =.018f;
...
void bustyre1()
{
	...
	GLfloat x=-0.496875f; GLfloat y=-0.557407f; GLfloat radius =.01f;
	int triangleAmount = 100; //# of lines used to draw circle
...
void bustyre2()
{
	...
	GLfloat p=-0.311458f; GLfloat q=-0.558259f; GLfloat radius =.018f;
	int triangleAmount = 100; //# of lines used to draw circle
...
void bustyre3()
{
	...
	GLfloat p=-0.311458f; GLfloat q=-0.558259f; GLfloat radius =.01f;
	int triangleAmount = 100; //# of lines used to draw circle
...
glVertex2f(-0.084375f,-0.57037f);
 glVertex2f(0.090625f,-0.57037f);
   glVertex2f(0.0385417f,-0.514815f);
    glVertex2f(0.0333333f,-0.514815f);
    glVertex2f(-0.059375f,-0.538889f);
    glEnd();///*/
    glBegin(GL_QUADS);
 glColor3ub(223,23,93);
...
glVertex2f(0.0166667f,-0.522222f);
	...
	GLfloat x=0.104167f; GLfloat y=-0.655556f; GLfloat radius =.02f;
	int triangleAmount = 100; //# of lines used to draw circle
...
void tyre2nd()
{
  glPushMatrix();
	...
	GLfloat x=0.104167f; GLfloat y=-0.655556f; GLfloat radius =.01f;
	int triangleAmount = 100; //# of lines used to draw circle
...
void tyre()
{
   ...
   int j;
	...
	GLfloat p=-0.071875f; GLfloat q=-0.65182f; GLfloat Radius =.02f;
...
void tyreM()
{
   ...
   int j;
	...
	GLfloat p=-0.071875f; GLfloat q=-0.65182f; GLfloat Radius =.01f;
	int X= 100; //# of lines used to draw circle
...
*/
  ...
  glBegin(GL_TRIANGLES);
     ...
     glVertex2f(-0.85f,0.03f);
      ...
      /* glBegin(GL_QUADS);
       glColor3ub(9,9,4);
        glVertex2f(-0.84f,0.037f);
         glVertex2f(-0.84f,0.037f);
         glVertex2f(-0.84f,0.0462963f);
          glVertex2f(-0.83f,0.0555556f);
          glEnd();*/
          glBegin(GL_POLYGON);
...
void car2()
{
  ...
  glBegin(GL_POLYGON);
   ...
   glVertex2f(-0.758333f,-0.538889f);
   glVertex2f(-0.926042f,-0.538889f);
    glEnd();
...
glVertex2f(-0.758333f,-0.538889f);
    glEnd();
     glBegin(GL_POLYGON);
    glColor3ub(64,91,85);
    glVertex2f(-0.901042f,-0.540741f);
   glVertex2f(-0.76875f,-0.538889f);
    glVertex2f(-0.8f,-0.474074f);
    glVertex2f(-0.871875f,-0.474074f);
    glEnd();

glLineWidth(5);
        glBegin(GL_LINES);
        glColor3ub(139,0,0);
        glVertex2f(-0.832292f,-0.542593f);
        glVertex2f(-0.832292f,-0.474074f);
        glEnd();

        glBegin(GL_POLYGON);
    glColor3ub(237,212,7);
   glVertex2f(-0.86875f,-0.518519f);
   glVertex2f(-0.848958f,-0.518519f);
   glVertex2f(-0.848958f,-0.492593f);
   glVertex2f(-0.86875f,-0.492593f);
    glEnd();


    glBegin(GL_POLYGON);
    glColor3ub(237,212,7);
  glVertex2f(-0.81875f,-0.518519f);
  glVertex2f(-0.798958f,-0.518519f);
   glVertex2f(-0.798958f,-0.496296f);
   glVertex2f(-0.81875f,-0.496296f);
    glEnd();
   ...
   int j;
	...
	GLfloat p=-0.882292f; GLfloat q=-0.642593f; GLfloat Radius =.02f;
	int X= 100; //# of lines used to draw circle
...
int j;
	...
	GLfloat p=-0.882292f; GLfloat q=-0.642593f; GLfloat Radius =.01f;
	int X= 100; //# of lines used to draw circle
...
int j;
	...
	GLfloat p=-0.755208f; GLfloat q=-0.642593f; GLfloat Radius =.02f;
	int X= 100; //# of lines used to draw circle
...
int j;
	...
	GLfloat p=-0.755208f; GLfloat q=-0.642593f; GLfloat Radius =.01f;
	int X= 100; //# of lines used to draw circle
...
{
    GLfloat x=X; GLfloat y=Y; GLfloat radius =.037f; //tree structure
...
{
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);  //bench stand 1
    glVertex2f(X, Y);
    glVertex2f(X, Y-0.05);
    glEnd();

    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);  //bench stand 2
    glVertex2f(X+0.03, Y);
    glVertex2f(X+0.03, Y-0.05);
    glEnd();

    glBegin(GL_QUADS);  //bench upper part
    ...
    glBegin(GL_QUADS);
    glColor3ub(205,133,63); //bench lower part
    glVertex2f(X, Y-0.02);
    glVertex2f(X+0.03, Y-0.02);
...
/*void treebackgraound()
{


glBegin(GL_POLYGON);
    glColor3ub(91,207,56);
    glVertex2f(-1.0f,-0.996296f);
     glVertex2f(-0.804167f,-0.996296f);
      glVertex2f(-0.804167f,-0.9f);
    ...
    glVertex2f(-1.0f,-0.9f);
      glVertex2f(-0.804167f,-0.9f);
    glVertex2f(-0.802083f,-0.825926f);
      glVertex2f(-1.0f,-0.822222f);
    glEnd();
    ...
    glColor3ub(21,54,10);
     glVertex2f(-1.0f,-0.822222f);
      glVertex2f(-0.802083f,-0.825926f);
     glVertex2f(-0.802083f,-0.764815f);
      glVertex2f(-1.0f,-0.764815f);
    glEnd();
    ...
    glColor3ub(14,36,7);
     glVertex2f(-1.0f,-0.764815f);
      glVertex2f(-0.802083f,-0.764815f);
    glVertex2f(-0.801042f,-0.701852f);
       glVertex2f(-1.0f,-0.701852f);
    glEnd();
}
...
void tree1()
{
    ...
    glColor3ub(74,26,23);
    glVertex2f(-0.970833f,-0.97963f);
    glVertex2f(-0.964583f,-0.97963f);
    glVertex2f(-0.964583f,-0.953704f);
     glVertex2f(-0.970833f,-0.953704f);
     glVertex2f(-0.970833f,-0.97963f);
    glEnd();
    ...
    glColor3ub(0,100,36);
     glVertex2f(-0.988542f,-0.951852f);
     glVertex2f(-0.947917f,-0.951852f);
   glVertex2f(-0.967708f,-0.905556f);

    glEnd();

    glBegin(GL_TRIANGLES); //tree1
    glColor3ub(0,100,36);
     glVertex2f(-0.986458f,-0.92037f);
     glVertex2f(-0.951042f,-0.92037f);
  glVertex2f(-0.96875f,-0.87963f);

    glEnd();

     glBegin(GL_TRIANGLES); //tree1
    glColor3ub(0,100,36);
      glVertex2f(-0.980208f,-0.887037f);
     glVertex2f(-0.95625f,-0.887037f);
   glVertex2f(-0.967708f,-0.844444f);
    glEnd();
...
void tree2()
{
    ...
    glColor3ub(74,26,23);
      glVertex2f(-0.954167f,-0.9f);
   glVertex2f(-0.944792f,-0.9f);
   glVertex2f(-0.945833f,-0.859259f);
 glVertex2f(-0.954167f,-0.859259f);
      glVertex2f(-0.954167f,-0.9f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree2
    glColor3ub(0,100,36);
       glVertex2f(-0.978125f,-0.861111f);
     glVertex2f(-0.921875f,-0.861111f);
    glVertex2f(-0.948958f,-0.805556f);

    glEnd();

    glBegin(GL_TRIANGLES); //tree2
    glColor3ub(0,100,36);
        glVertex2f(-0.972917f,-0.814815f);
      glVertex2f(-0.923958f,-0.814815f);
    glVertex2f(-0.948958f,-0.75f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree2
    glColor3ub(0,100,36);
        glVertex2f(-0.963542f,-0.766667f);
       glVertex2f(-0.932292f,-0.766667f);
  glVertex2f(-0.948958f,-0.714815f);
    glEnd();


    glBegin(GL_POLYGON); //tree3
    glColor3ub(74,26,23);
        glVertex2f(-0.94375f,-0.998148f);
     glVertex2f(-0.938542f,-0.998148f);
 glVertex2f(-0.938542f,-0.985185f);
   glVertex2f(-0.94375f,-0.985185f);
        glVertex2f(-0.94375f,-0.998148f);
    glEnd();
...
void tree3()
{
    ...
    glColor3ub(0,100,36);
          glVertex2f(-0.95625f,-0.990741f);
          glVertex2f(-0.926042f,-0.990741f);
    glVertex2f(-0.939583f,-0.957407f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree3
    glColor3ub(0,100,36);
        glVertex2f(-0.953125f,-0.962963f);
           glVertex2f(-0.928125f,-0.962963f);
   glVertex2f(-0.940625f,-0.92963f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree3
    glColor3ub(0,100,36);
        glVertex2f(-0.947917f,-0.938889f);
           glVertex2f(-0.932292f,-0.938889f);
      glVertex2f(-0.939583f,-0.912963f);
    glEnd();
}
void tree4()
{
    ...
    glColor3ub(74,26,23);
        glVertex2f(-0.923958f,-0.998148f);
     glVertex2f(-0.914583f,-0.998148f);
    glVertex2f(-0.915625f,-0.931481f);
     glVertex2f(-0.925f,-0.931481f);
       glVertex2f(-0.923958f,-0.998148f);
    glEnd();


    glBegin(GL_TRIANGLES); //tree4
    glColor3ub(0,100,36);
          glVertex2f(-0.947917f,-0.933333f);
            glVertex2f(-0.892708f,-0.933333f);
       glVertex2f(-0.920833f,-0.877778f);
    ...
    glEnd();
      ...
      glBegin(GL_TRIANGLES); //tree4
    glColor3ub(0,100,36);
           glVertex2f(-0.941667f,-0.888889f);
             glVertex2f(-0.896875f,-0.888889f);
      glVertex2f(-0.919792f,-0.833333f);
    glEnd();
...
void tree5()
{
    ...
    glColor3ub(74,26,23);
         glVertex2f(-0.895833f,-0.988889f);
      glVertex2f(-0.886458f,-0.990741f);
      glVertex2f(-0.8875f,-0.959259f);
        glVertex2f(-0.895833f,-0.957407f);
        glVertex2f(-0.895833f,-0.988889f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree5
    glColor3ub(0,100,36);
            glVertex2f(-0.916667f,-0.959259f);
              glVertex2f(-0.865625f,-0.961111f);
          glVertex2f(-0.89375f,-0.907407f);
    glEnd();

    glBegin(GL_TRIANGLES); //tree5
    glColor3ub(0,100,36);
             glVertex2f(-0.914583f,-0.92037f);
               glVertex2f(-0.869792f,-0.92037f);
          glVertex2f(-0.891667f,-0.87037f);
    glEnd();


    glBegin(GL_TRIANGLES); //tree5
    glColor3ub(0,100,36);
              glVertex2f(-0.904167f,-0.877778f);
                glVertex2f(-0.879167f,-0.877778f);
          glVertex2f(-0.891667f,-0.833333f);
    glEnd();
}
...
{
    glBegin(GL_QUADS);
    glColor3ub(52, 235, 58); // field
    glVertex2f(0.242f, -0.7f);
    glVertex2f(0.242f, -1.0f);
    glVertex2f(1.0f, -1.0f);
    glVertex2f(1.0f, -0.7f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(112,128,144);         //field boundary 1
    glVertex2f(0.242f, -0.7f);
    glVertex2f(0.242f, -0.745f);
    glVertex2f(1.0f, -0.745f);
    glVertex2f(1.0f, -0.7f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.245f, -0.72f);
    glVertex2f(0.985f, -0.72f);
    glEnd();
    glLineWidth(1.8);
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.245f, -0.73f);
    glVertex2f(0.985f, -0.73f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(112,128,144);         //field boundary 2
    glVertex2f(0.242f, -0.745f);
    glVertex2f(0.242f, -1.0f);
    ...
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.246f, -0.72f);
    glVertex2f(0.246f, -1.0f);
    glEnd();
    glLineWidth(1.8);
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.248f, -0.72f);
    glVertex2f(0.248f, -1.0f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.242f, -0.98f);
    glVertex2f(0.987f, -0.98f);
    glEnd();
    glLineWidth(1.8);
    glBegin(GL_LINES);
    glColor3ub(0, 0, 0);
    glVertex2f(0.244f, -0.989f);
    glVertex2f(0.989f, -0.989f);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(112,128,144);         //field boundary 4
    glVertex2f(0.242f, -0.98f);
    glVertex2f(0.242f, -1.0f);
    glVertex2f(1.0f, -1.0f);
...
void parkTrees(float X, float Y)
{
    GLfloat x=X; GLfloat y=Y; GLfloat radius =.037f; //tree structure
...
{
    glPushMatrix();
    glTranslatef(positions, 0.0f, 0.0f);
...
void benches()
{
    ...
    glColor3ub(178,34,34);
     glVertex2f(-0.571875f,-0.790741f);
      glVertex2f(-0.571875f,-0.937037f);
    glEnd();

    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(178,34,34);
      glVertex2f(-0.573875f,-0.937037f);
      glVertex2f(-0.528125f,-0.937037f);
    glEnd();
  ...
  glLineWidth(3);
    ...
    glColor3ub(178,34,34);
      glVertex2f(-0.528125f,-0.937037f);
       glVertex2f(-0.528125f,-0.790741f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(178,34,34);
      glVertex2f(-0.571875f,-0.905556f);
      glVertex2f(-0.528125f,-0.905556f);
    glEnd();

     glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(178,34,34);
     glVertex2f(-0.571875f,-0.875926f);
      glVertex2f(-0.528125f,-0.875926f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(178,34,34);
     glVertex2f(-0.571875f,-0.846296f);
      glVertex2f(-0.528125f,-0.846296f);
    glEnd();
    ...
    glBegin(GL_LINES);
    glColor3ub(178,34,34);
      glVertex2f(-0.571875f,-0.82037f);
      glVertex2f(-0.528125f,-0.82037f);
    glEnd();
  ...
  glBegin(GL_QUADS);
    glColor3ub(139,69,19);
    glVertex2f(-0.569792f,-0.788889f);
    glVertex2f(-0.510417f,-0.933333f);
    glVertex2f(-0.469792f,-0.933333f);
    glVertex2f(-0.53125f,-0.788889f);
    glEnd();
}
void football()
{
...
void fan()
{
    ...
    glVertex2f(-0.784375f,-0.838889f);
    glVertex2f(-0.784375f,-1.0f);
    glVertex2f(-0.777083f,-1.0f);
    glVertex2f(-0.777083f,-0.838889f);
    glEnd();
  ...
  GLfloat twicePi = 2.0f * PI;
    ...
    glLineWidth(3.5);
    glBegin(GL_LINES);
    glColor3ub(105,196,220);
    glVertex2f(-0.789583f,-0.835185f);
    glVertex2f(-0.823958f,-0.861111f);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
    glColor3ub(105,196,220);
    glVertex2f(-0.78125f,-0.812963f);
    glVertex2f(-0.78125f,-0.769f);
    glEnd();
    glPopMatrix();
    ...
    glBegin(GL_LINES);
    glColor3ub(105,196,220);
    glVertex2f(-0.771875f,-0.833333f);
    glVertex2f(-0.738542f,-0.86);
    glEnd();
    glPopMatrix();
}
...
void text1() {
    glClearColor(0.8f, 0.8f, 0.8f, 0.0f); // Set background color to light gray
    glClear(GL_COLOR_BUFFER_BIT); // Clear the color buffer (background)

    glColor3f(1.0, 0.0, 0.0);
    renderBitmapString(-0.7f, 0.7f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics [C]");

    glColor3f(0.0, 0.0, 1.0);
    renderBitmapString(-0.7f, 0.5f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Project Title: MetroRail Station");

    glColor3f(0.0, 0.5, 0.0);
    renderBitmapString(-0.7f, 0.3f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Group Member List:");

    glColor3f(0.0, 0.0, 0.0);
    renderBitmapString(-0.7f, 0.2f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "AL FESANI    ID: 21-44381-1    30%");
    renderBitmapString(-0.7f, 0.1f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "SHORBANI CHOWDHURY    ID: 21-44378-1   25%");
    renderBitmapString(-0.7f, 0.0f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "FARHAN SADIK    ID: 21-44403-1   25%");
    renderBitmapString(-0.7f, -0.1f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "SAYED FARHAD SHAHRIAR ALVI    ID: 21-44403-1  10%");
    renderBitmapString(-0.7f, -0.2f, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "TURJO CHANDRA RAY   ID:21-4451-1   10%");


    glColor3f(0.5, 0.5, 0.5); // Set text color to gray
    renderBitmapString(-0.8f, -0.3f, 0.0f, GLUT_BITMAP_HELVETICA_18, "Mahfujur Rahman");
    renderBitmapString(-0.8f, -0.4f, 0.0f, GLUT_BITMAP_HELVETICA_18, "Lecturer");
    renderBitmapString(-0.8f, -0.5f, 0.0f, GLUT_BITMAP_HELVETICA_18, "Department of Computer Science");
renderBitmapString(-0.8f, -0.6, 0.0f, GLUT_BITMAP_HELVETICA_18, "Faculty of Science and Technology");
renderBitmapString(-0.9f, -0.7f, 0.0f, GLUT_BITMAP_HELVETICA_18, "American International University-Bangladesh (AIUB)");
    glEnd();
}
void humanx()
{
   ...
   // glTranslatef(carposition, 0.0f, 0.0f);
	...
	GLfloat x=0.138542f; GLfloat y=-0.412963f; GLfloat radius =.016f;
	int triangleAmount = 100; //# of lines used to draw circle
	...
	glBegin(GL_QUADS);
    glColor3ub(112,128,144);         //field boundary 3
    glVertex2f(0.126042f,-0.427778f);
    glVertex2f(0.126042f,-0.475926f);
    glVertex2f(0.151042f,-0.475926f);
    glVertex2f(0.151042f,-0.427778f);
    glEnd();

    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(255, 0, 0);
   glVertex2f(0.132292f,-0.475926f);
  glVertex2f(0.132292f,-0.498148f);
    glEnd();

    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(255, 0, 0);
   glVertex2f(0.145833f,-0.475926f);
   glVertex2f(0.145833f,-0.498148f);
    glEnd();

     glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(255, 0, 0);
  glVertex2f(0.15f,-0.438889f);
   glVertex2f(0.165625f,-0.448148f);
    glEnd();
    glLineWidth(3);
    glBegin(GL_LINES);
    glColor3ub(255, 0, 0);
  glVertex2f(0.15f,-0.457407f);
   glVertex2f(0.161458f,-0.47037f);
    glEnd();
...
humany()
{
   ...
   // glTranslatef(busposition, 0.0f, 0.0f);
	...
	GLfloat x=0.39375f; GLfloat y=-0.409259f; GLfloat radius =.016f;
	int triangleAmount = 100; //# of lines used to draw circle
...
void rainLine(float x, float y)
{
    ...
    glBegin(GL_LINES);
    glColor3ub(255, 255, 255);
    glVertex2f(x +0.12, y+0.3);
    glVertex2f(x +0.14, y +0.4);
    glEnd();

    glLineWidth(5);
    glBegin(GL_LINES);
    glColor3ub(255, 255, 255);
    glVertex2f(x +0.16, y+0.4);
    glVertex2f(x +0.18, y +0.5);
    glEnd();
...
//    Boat2();
    ...
    goalposts();
    rightPark();
    parkTrees(0.3f, -0.85f); // tree 1
    parkTrees(0.8f, -0.75f); // tree 2
    parkTrees(0.5f, -0.75f); // tree 3
    parkTrees(0.45f, -0.9f); // tree 4
    parkTrees(0.55f, -0.9f); // tree 5
    parkTrees(0.75f, -0.8f); // tree 6
    parkTrees(0.75f, -0.9f); // tree 7
    parkTrees(0.65f, -0.88f); // tree 8
    parkTrees(0.6f, -0.9f); // tree 9
    parkTrees(0.5f, -0.82f); // tree 10
    parkTrees(0.7f, -0.85f); // tree 11
